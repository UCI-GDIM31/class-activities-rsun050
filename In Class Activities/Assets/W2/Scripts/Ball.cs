...
public class Ball : MonoBehaviour
{
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        //_bounces = _bounces + 2;      // adds 2
        //_bounces + 1                  // bad syntax
        //_bounces --;                  // subtracts 1
        _bounces++;                     // LGTM
        //_bounces += 1                 // also works
        // STEP 1 -------------------------------------------------------------
        ...
        _bouncesText.text = "Bounces: " + _bounces; // joyous!
        ...
        // r += 0.1f                // missing semicolon :(            this one got me for a sec >:(
        // r * 0.1;                 // missing f for float + bad syntax
        r = r + 0.1f;               // LGTM
        //r = r * 0.1f;             // sets r to 10% of its original value
        // r += 0.1;                // missing f for float             this one also got me
        // STEP 2 -------------------------------------------------------------
        ...
        if (r > 1.0f)
        {
            ...
            //r = 0.0f              // missing semicolon
            r = 0.0f;               // LGTM
            //r 0.0f;               // where operator?
            // STEP 3 ---------------------------------------------------------
        }

        // STEP 4 -------------------------------------------------------------
        // Uncomment the below line and fix it to SUBTRACT 0.1 from the value of 'g'.
        //g -= 0.1f                 // missing semicolon lol
        g -= 0.1f;
        // STEP 4 -------------------------------------------------------------
